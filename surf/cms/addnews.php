...
if ($_SESSION[user_loggedIn] == true)
{
	...
	if ($_POST[addnews] == true)
	{
		if ($_POST[step2] == true)
		{
			...
			$text = "Uw nieuwsbericht is toegevoegd.
		...
		{
		/* step 1; check data */
		$text = $news->verifyStep1($_POST[news_title], $_POST[news_rubriek_id], $_POST[news_image], $_POST[news_short], $_POST[news_message]);
		}
	}
	else
	{
...
$lay_out->main("Nieuwsberichten toevoegen aan $_SESSION[cms_name]", $text, $nl2br);

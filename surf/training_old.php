			...
			<div class="trainingAanmeldingen">
				<ul>
				  <div class="heterTitel" style="color: #FFFFFF;">Wie komen er allemaal?</div>
					<span style="font-size: 10px; color: #FFFFFF;"><?php echo($aantal_aanmeldingen); ?> aanmeldingen voor de training van <?php echo(date("d/m", strtotime($volgende_dinsdag))); ?></span>
<?php
                  ...
                  <tr>
                    ...
                    <td width="337" rowspan="3"><input name="aanmeldBevestig" type="radio" value="2" onclick="this.form.datum.disabled=true;" checked tabindex="3">
                      ...
                      <select name="datum" id="datum" disabled="disabled" tabindex="5">
						...
						<option value="2010-03-30" <?php if(date("Ymd") > '20100330') { echo "selected=\"selected\""; } ?> >di. 30 maart 2010</option>
						<option value="2010-04-06" <?php if(date("Ymd") > '20100406') { echo "selected=\"selected\""; } ?> >di. 6 april 2010</option>
						<option value="2010-04-13" <?php if(date("Ymd") > '20100413') { echo "selected=\"selected\""; } ?> >di. 13 april 2010</option>
						<option value="2010-04-20" <?php if(date("Ymd") > '20100420') { echo "selected=\"selected\""; } ?> >di. 20 april 2010</option>
						<option value="2010-04-27" <?php if(date("Ymd") > '20100427') { echo "selected=\"selected\""; } ?> >di. 27 april 2010</option>
						<option value="2010-05-04" <?php if(date("Ymd") > '20100504') { echo "selected=\"selected\""; } ?> >di. 4 mei 2010</option>
						<option value="2010-05-11" <?php if(date("Ymd") > '20100511') { echo "selected=\"selected\""; } ?> >di. 11 mei 2010</option>
						<option value="2010-05-18" <?php if(date("Ymd") > '20100518') { echo "selected=\"selected\""; } ?> >di. 18 mei 2010</option>
						<option value="2010-05-25" <?php if(date("Ymd") > '20100525') { echo "selected=\"selected\""; } ?> >di. 25 mei 2010</option>
						<option value="2010-06-01" <?php if(date("Ymd") > '20100601') { echo "selected=\"selected\""; } ?> >di. 1 juni 2010</option>
						<option value="2010-06-08" <?php if(date("Ymd") > '20100608') { echo "selected=\"selected\""; } ?> >di. 8 juni 2010</option>
						<option value="2010-06-15" <?php if(date("Ymd") > '20100615') { echo "selected=\"selected\""; } ?> >di. 15 juni 2010</option>
						<option value="2010-06-22" <?php if(date("Ymd") > '20100622') { echo "selected=\"selected\""; } ?> >di. 22 juni 2010</option>
						<option value="2010-06-29" <?php if(date("Ymd") > '20100629') { echo "selected=\"selected\""; } ?> >di. 29 juni 2010</option>
						<option value="2010-07-06" <?php if(date("Ymd") > '20100706') { echo "selected=\"selected\""; } ?> >di. 6 juli 2010</option>
						<option value="2010-07-13" <?php if(date("Ymd") > '20100713') { echo "selected=\"selected\""; } ?> >di. 13 juli 2010</option>
						<option value="2010-07-20" <?php if(date("Ymd") > '20100720') { echo "selected=\"selected\""; } ?> >di. 20 juli 2010</option>
						<option value="2010-07-27" <?php if(date("Ymd") > '20100727') { echo "selected=\"selected\""; } ?> >di. 27 juli 2010</option>
						<option value="2010-08-03" <?php if(date("Ymd") > '20100803') { echo "selected=\"selected\""; } ?> >di. 3 augustus 2010</option>
						<option value="2010-08-10" <?php if(date("Ymd") > '20100810') { echo "selected=\"selected\""; } ?> >di. 10 augustus 2010</option>
						<option value="2010-08-17" <?php if(date("Ymd") > '20100817') { echo "selected=\"selected\""; } ?> >di. 17 augustus 2010</option>
						<option value="2010-08-24" <?php if(date("Ymd") > '20100824') { echo "selected=\"selected\""; } ?> >di. 24 augustus 2010</option>
						<option value="2010-08-31" <?php if(date("Ymd") > '20100831') { echo "selected=\"selected\""; } ?> >di. 31 augustus 2010</option>
						<option value="2010-09-07" <?php if(date("Ymd") > '20100907') { echo "selected=\"selected\""; } ?> >di. 7 september 2010</option>
						<option value="2010-09-14" <?php if(date("Ymd") > '20100914') { echo "selected=\"selected\""; } ?> >di. 14 september 2010</option>
						<option value="2010-09-21" <?php if(date("Ymd") > '20100921') { echo "selected=\"selected\""; } ?> >di. 21 september 2010</option>
						<option value="2010-09-28" <?php if(date("Ymd") > '20100928') { echo "selected=\"selected\""; } ?> >di. 28 september 2010</option>
					  </select>				    </td>
                  </tr>
                  <tr>
...
<div class="recentNieuwsBericht">
				...
				<ul style="list-style-type: square;"><?php
					...
					{
						$mnd = date("n", strtotime($value));
						?><li style="list-style-type: square; padding-left: 20px; <?php if(date("Y-m-d") > $value) { ?>text-decoration:line-through<?php } ?>" >di <?php echo(date("d", strtotime($value))); ?> <?php echo($maanden[$mnd]); ?> <?php echo(date("Y", strtotime($value))); ?></li><?php
					}

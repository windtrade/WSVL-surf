...
if($_GET[cart]){
	...
	if($_SESSION[shoppingcart]){
					//It exists, so update array
					$_SESSION[shoppingcart] = $product->updateCart($_SESSION[shoppingcart],$_GET[photo_id],1);
				}
				else
				{
					//It doesn't exist, create array
					
					$_SESSION[shoppingcart] = $product->newArray($_POST[photo_id], 1);
				}
	}
